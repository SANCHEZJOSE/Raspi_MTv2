...
/*=========================================================================
    ...
    -----------------------------------------------------------------------*/
    const int ADS1115_CONVERSIONDELAY  =1163;
/*=========================================================================*/
...
protected:
 ...
 public:
  ADS1115(uint8_t i2cAddress = ADS1115_ADDRESS);
  ~ADS1115(){bcm2835_i2c_end();}
  void begin(void);
  void   Differential_0_1(void);
  void   Differential_2_3(void);
